	...
	public class HollowKnightComponent {
        ...
        private SplitterAction CheckSplit(SplitName split, string nextScene, string currScene) {
            ...
            switch (split) {
                ...
                case SplitName.BrettaHouseBubbles: shouldSplit = nextScene == "BrettaHouseBubbles" && currScene != nextScene; break;
                case SplitName.BrettaHouseBumpers: shouldSplit = nextScene == "BrettaHouseBumpers" && currScene != nextScene; break;
                case SplitName.BrettaHouseSwitches: shouldSplit = nextScene == "BrettaHouseSwitches" && currScene != nextScene; break;
                case SplitName.BrettaHouseZippers: shouldSplit = nextScene == "BrettaHouseZippers" && currScene != nextScene; break;
                ...
                case SplitName.CrystalPeakHuntersNotes:
                    shouldSplit =
                        ...
                        && mem.PlayerData<int>(Offset.killsCrystalCrawler) == 0 // Glimback
                        && mem.PlayerData<int>(Offset.killsZombieMiner) == 0 // Husk Miner
                        && mem.PlayerData<int>(Offset.killsMinesCrawler) == 0; // Shardmite
                    break;
                ...
                */
                ...
                case SplitName.BronzeEnd: // 2 × Gruz Mom
                    ...
                    shouldSkip =
                        ...
                        && nextScene != currScene;
                    break;
                #endregion Trial of the Warrior
                ...
                case SplitName.SilverEnd: // 2 × Oblobbles
                    ...
                    shouldSkip =
                        ...
                        && nextScene != currScene;
                    break;
                #endregion Trial of the Conqueror
