...
namespace LiveSplit.HollowKnight {
    ...
    public enum SplitName {
        ...
        HuntersMark,
        [Description("国王Brand（物品）"), ToolTip("Splits when obtaining the King's Brand")]
        KingsBrand,
        ...
        DungDefender,
        [Description("粪虫防御者Idol（物品）"), ToolTip("Splits when picking up Dung Defender idol as the first idol")]
        DungDefenderIdol,
        [Description("GladeIdol（物品）"), ToolTip("Splits when picking up the King's Idol in the Spirits' Glade")]
        GladeIdol,
        ...
        GreyPrinceEssence,
        [Description("灰色王子左特Level（Boss）"), ToolTip("Splits each time defeating Grey Prince Zote in Bretta's dream")]
        OnDefeatGPZ,
        ...
        MarmuEssence,
        [Description("大型苔藓冲锋者（Boss）"), ToolTip("Splits when killing Massive Moss Charger")]
        MegaMossCharger,
        ...
        [Description("白色防御者Level（Boss）"), ToolTip("Splits each time defeating White Defender in Dung Defender's dream")]
        ...
        PreGrimmShop,
        [Description("106%格林前购物（切换场景）"), ToolTip("Splits when Lantern + Vessel Fragment(5) + Mask Shard(4) have been acquired")]
        PreGrimmShopTrans,
        [Description("1xx%斯莱最终购物（切换场景）"), ToolTip("Splits on leaving Sly's shop after having bough Sprintmaster and Vessel Frag 8")]
        SlyShopFinished,
        ...
        CityGateOpen,
        [Description("泪水之城大门和螳螂领主defeated（事件）"), ToolTip("to make sure you don't forget mantis lords")]
        CityGateAndMantisLords,
        [Description("死亡（事件）"), ToolTip("Splits when player hp is 0")]
        PlayerDeath,
        [Description("暗影击杀（事件）"), ToolTip("Splits when the shade is killed")]
        ShadeKilled,
        ...
        [Description("乘坐鹿角虫（事件）"), ToolTip("Splits while riding the stag")]
        RidingStag,
        [Description("拯救阿布（事件）"), ToolTip("Splits when saving Cloth in Ancient Basin")]
        SavedCloth,
        [Description("水晶山峰LiftOpened（事件）"), ToolTip("Splits when opening the lever for the lift between Dirtmouth and Crystal Peaks")]
        MineLiftOpened,
        ...
        ColosseumGold,
        [Description("斗兽场Entrance1（切换场景）"), ToolTip("Splits on the transition into the trial")]
        ColosseumBronzeEntry,
        [Description("斗兽场Entrance2（切换场景）"), ToolTip("Splits on the transition into the trial")]
        ColosseumSilverEntry,
        [Description("斗兽场Entrance3（切换场景）"), ToolTip("Splits on the transition into the trial")]
        ColosseumGoldEntry,
        ...
        GreenpathStation,
        [Description("王后驿站（鹿角站）"), ToolTip("Splits when obtaining Queen's Station Stag Station")]
        QueensStationStation,
        [Description("王后花园（鹿角站）"), ToolTip("Splits when obtaining Queen's Gardens Stag Station")]
        QueensGardensStation,
        [Description("城市仓库（鹿角站）"), ToolTip("Splits when obtaining City Storerooms Stag Station")]
        StoreroomsStation,
        [Description("国王驿站（鹿角站）"), ToolTip("Splits when obtaining King's Station Stag Station")]
        KingsStationStation,
        ...
        [Description("蘑菇先生1（地点）"), ToolTip("Splits when talking to Mister Mushroom in Fungal Wastes")]
        MrMushroom1,
        [Description("蘑菇先生2（地点）"), ToolTip("Splits when talking to Mister Mushroom in Kingdom's Edge")]
        MrMushroom2,
        [Description("蘑菇先生3（地点）"), ToolTip("Splits when talking to Mister Mushroom in Deepnest")]
        MrMushroom3,
        [Description("蘑菇先生4（地点）"), ToolTip("Splits when talking to Mister Mushroom in Mato's Hut")]
        MrMushroom4,
        [Description("蘑菇先生5（地点）"), ToolTip("Splits when talking to Mister Mushroom in Ancient Basin")]
        MrMushroom5,
        [Description("蘑菇先生6（地点）"), ToolTip("Splits when talking to Mister Mushroom by Overgrown Mound")]
        MrMushroom6,
        [Description("蘑菇先生7（地点）"), ToolTip("Splits when talking to Mister Mushroom in King's Pass")]
        MrMushroom7,
        ...
        BasinEntry,
        [Description("蓝湖（切换场景）"), ToolTip("Splits on transition to Blue Lake (from either side)")]
        BlueLake,
        [Description("水晶山峰入口（切换场景）"), ToolTip("Splits on transition to the room where the dive and toll entrances meet, or the room right of Dirtmouth")]
        CrystalPeakEntry,
        [Description("结晶山丘离开（切换场景）"), ToolTip("Splits on transition from Crystal Mound")]
        CrystalMoundExit,
        [Description("进入任意梦境（切换场景）"), ToolTip("Splits when entering any dream world")]
        EnterAnyDream,
        [Description("雾之峡谷（切换场景）"), ToolTip("Splits on transition to East Fog Canyon")]
        FogCanyonEntry,
        [Description("真菌荒地入口（切换场景）"), ToolTip("Splits on transition to Fungal Wastes (scene below Crossroads, right of QS, left of Waterways or with Spore Shroom")]
        FungalWastesEntry,
        [Description("华丽躯壳击杀（切换场景）"), ToolTip("Splits on transition after Gorgeous Husk defeated")]
        TransGorgeousHusk,
        [Description("神居（切换场景）"), ToolTip("Splits on transition to Godhome")]
        EnterGodhome,
        ...
        TransClaw,
        [Description("拥有Fireball（切换场景）"), ToolTip("Splits on transition after Vengeful Spirit acquired")]
        TransVS,
        ...
        [Description("王国边境（切换场景）"), ToolTip("Splits on transition to Kingdom's Edge from King's Station")]
        KingdomsEdgeEntry,
        [Description("王国边境过载（切换场景）"), ToolTip("Splits on transition to Kingdom's Edge from King's Station while overcharmed")]
        KingdomsEdgeOvercharmedEntry,
        [Description("梦魇之王格林梦境（切换场景）"), ToolTip("Splits on transition to NKG dream")]
        EnterNKG,
        [Description("王后花园入口（切换场景）"), ToolTip("Splits on transition to QG scene following QGA or above Deepnest")]
        QueensGardensEntry,
        ...
        Longnail,
        [Description("MarkofPride（护符）"), ToolTip("Splits when obtaining the Mark of Pride charm")]
        MarkOfPride,
        ...
        SteadyBody,
        [Description("ThornsofAgony（护符）"), ToolTip("Splits when obtaining Thorns of Agony charm")]
        ThornsOfAgony,
        ...
        [Description("营救幼虫收藏家全部（幼虫）"), ToolTip("Splits when rescuing all three grubs in Ruins2_11. (On 1221, splits for right grub)")]
        GrubCityCollectorAll,
        [Description("营救幼虫收藏家（幼虫）"), ToolTip("Splits when rescuing any grub in Ruins2_11")]
        GrubCityCollector,
        ...
        [Description("100精华(精华)"), ToolTip("Essence")]
        Essence100,
        [Description("200精华(精华)"), ToolTip("Essence")]
        Essence200,
        [Description("300精华(精华)"), ToolTip("Essence")]
        Essence300,
        [Description("400精华(精华)"), ToolTip("Essence")]
        Essence400,
        [Description("500精华(精华)"), ToolTip("Essence")]
        Essence500,
        [Description("600精华(精华)"), ToolTip("Essence")]
        Essence600,
        [Description("700精华(精华)"), ToolTip("Essence")]
        Essence700,
        [Description("800精华(精华)"), ToolTip("Essence")]
        Essence800,
        [Description("900精华(精华)"), ToolTip("Essence")]
        Essence900,
        [Description("1000精华(精华)"), ToolTip("Essence")]
        Essence1000,
        [Description("1100精华(精华)"), ToolTip("Essence")]
        Essence1100,
        [Description("1200精华(精华)"), ToolTip("Essence")]
        Essence1200,
        [Description("1300精华(精华)"), ToolTip("Essence")]
        Essence1300,
        [Description("1400精华(精华)"), ToolTip("Essence")]
        Essence1400,
        [Description("1500精华(精华)"), ToolTip("Essence")]
        Essence1500,
        [Description("1600精华(精华)"), ToolTip("Essence")]
        Essence1600,
        [Description("1700精华(精华)"), ToolTip("Essence")]
        Essence1700,
        [Description("1800精华(精华)"), ToolTip("Essence")]
        Essence1800,
        [Description("1900精华(精华)"), ToolTip("Essence")]
        Essence1900,
        [Description("2000精华(精华)"), ToolTip("Essence")]
        Essence2000,
        [Description("2100精华(精华)"), ToolTip("Essence")]
        Essence2100,
        [Description("2200精华(精华)"), ToolTip("Essence")]
        Essence2200,
        [Description("2300精华(精华)"), ToolTip("Essence")]
        Essence2300,
        [Description("2400精华(精华)"), ToolTip("Essence")]
        Essence2400,

        [Description("任意椅子(椅子)"), ToolTip("Splits when sitting on a bench")]
        BenchAny,/*
        [Description("德特茅斯(Bench)"), ToolTip("Splits when sitting on the bench in Dirtmouth")]
        BenchDirtmouth,
        [Description("马托(Bench)"), ToolTip("Splits when sitting on the bench in Mato's Hut")]
        BenchMato,
        [Description("十字路Hotsprings(Bench)"), ToolTip("Splits when sitting on the hotsprings bench in Crossroads")]
        BenchCrossroadsHotsprings,*/
        [Description("十字路Stag(Bench)"), ToolTip("Splits when sitting on the bench at Crossroads Stag")]
        BenchCrossroadsStag,/*
        [Description("萨鲁巴(Bench)"), ToolTip("Splits when sitting on the bench by Salubra")]
        BenchSalubra,
        [Description("Ancestral Mound (Bench)"), ToolTip("Splits when sitting on the bench in Ancestral Mound")]
        BenchAncestralMound,
        [Description("黑卵圣殿(Bench)"), ToolTip("Splits when sitting on the bench in Black Egg Temple")]
        BenchBlackEgg,
        ...
        BenchStoneSanctuary,
        [Description("苍绿之径Toll(Bench)"), ToolTip("Splits when sitting on the toll bench in Greenpath")]
        BenchGreenpathToll,*/
        [Description("苍绿之径Stag(Bench)"), ToolTip("Splits when sitting on the bench at Greenpath Stag")]
        BenchGreenpathStag,/*
        [Description("乌恩之湖(Bench)"), ToolTip("Splits when sitting on the bench at the Lake of Unn")]
        BenchLakeOfUnn,
        [Description("Sheo (Bench)"), ToolTip("Splits when sitting on the bench by Sheo's hut")]
        BenchSheo,
        [Description("Teacher's档案馆(Bench)"), ToolTip("Splits when sitting on the bench in Teacher's Archives")]
        BenchArchives,*/
        [Description("王后驿站(Bench)"), ToolTip("Splits when sitting on the bench in Queen's Station")]
        BenchQueensStation,/*
        [Description("食腿者(Bench)"), ToolTip("Splits when sitting on the bench at Leg Eater")]
        BenchLegEater,
        [Description("布蕾塔(Bench)"), ToolTip("Splits when sitting on the bench by Bretta")]
        BenchBretta,
        [Description("螳螂村(Bench)"), ToolTip("Splits when sitting on the bench in Mantis Village")]
        BenchMantisVillage,
        ...
        BenchCityToll,*/
        [Description("城市仓库(Bench)"), ToolTip("Splits when sitting on the bench in City Storerooms")]
        BenchStorerooms,/*
        [Description("Watcher's守望者的尖塔(Bench)"), ToolTip("Splits when sitting on the bench in Watcher's Spire")]
        BenchSpire,*/
        [Description("国王驿站(Bench)"), ToolTip("Splits when sitting on the bench in King's Station")]
        BenchKingsStation,/*
        ...
        BenchWaterways,
        [Description("深邃巢穴Hotsprings(Bench)"), ToolTip("Splits when sitting on the hotsprings bench in Deepnest")]
        BenchDeepnestHotsprings,
        [Description("失败Tramway(Bench)"), ToolTip("Splits when sitting on the bench at the Failed Tramway")]
        BenchFailedTramway,
        [Description("野兽巢穴(Bench)"), ToolTip("Splits when sitting on the bench in Beast's Den")]
        BenchDeepnestSpiderTown,
        [Description("盆地Toll(Bench)"), ToolTip("Splits when sitting on the toll bench in Ancient Basin")]
        BenchBasinToll,*/
        [Description("隐藏的鹿角站(Bench)"), ToolTip("Splits when sitting on the bench in Hidden Station")]
        BenchHiddenStation,/*
        [Description("奥罗(Bench)"), ToolTip("Splits when sitting on the bench at Oro's hut")]
        BenchOro,
        [Description("Camp (Bench)"), ToolTip("Splits when sitting on the bench at the camp in Kingdom's Edge")]
        BenchCamp,
        [Description("斗兽场(Bench)"), ToolTip("Splits when sitting on the bench at the Colosseum")]
        BenchColosseum,
        [Description("蜂巢(Bench)"), ToolTip("Splits when sitting on the bench in the Hive")]
        BenchHive,*/
        [Description("安息之地Stag(Bench)"), ToolTip("Splits when sitting on the bench at Resting Grounds Stag")]
        BenchRGStag,/*
        [Description("水晶山峰DarkRoom(Bench)"), ToolTip("Splits when sitting on the dark room bench in Crystal Peak")]
        BenchDarkRoom,
        [Description("水晶守卫(Bench)"), ToolTip("Splits when sitting on the Crystal Guardian's bench")]
        BenchCG1,
        [Description("灰色哀悼者(Bench)"), ToolTip("Splits when sitting on the bench by the Grey Mourner")]
        BenchFlowerQuest,
        [Description("王后花园柯尼法(Bench)"), ToolTip("Splits when sitting on the bench by Cornifer in Queen's Gardens")]
        BenchQGCornifer,
        [Description("王后花园Toll(Bench)"), ToolTip("Splits when sitting on the toll bench in Queen's Gardens")]
        BenchQGToll,*/
        [Description("王后花园Stag(Bench)"), ToolTip("Splits when sitting on the bench at Queen's Gardens Stag")]
        BenchQGStag,/*
        [Description("Tram (Bench)"), ToolTip("Splits when sitting on the bench in a tram")]
        BenchTram,
        [Description("白色宫殿Entrance(Bench)"), ToolTip("Splits when sitting on the bench inside the entrance to White Palace")]
        BenchWhitePalaceEntrance,
        [Description("白色宫殿中庭(Bench)"), ToolTip("Splits when sitting on the bench in the White Palace Atrium")]
        BenchWhitePalaceAtrium,
        [Description("白色宫殿Balcony(Bench)"), ToolTip("Splits when sitting on the bench at the White Palace Balcony")]
        BenchWhitePalaceBalcony,
        [Description("神居中庭(Bench)"), ToolTip("Splits when sitting on the bench in the Godhome Atrium")]
        BenchGodhomeAtrium,
        ...
        [Description("进入大黄蜂1（切换场景）"), ToolTip("Splits when entering Hornet 1 boss arena transition")]
        EnterHornet1,
        [Description("进入灵魂大师（切换场景）"), ToolTip("Splits when entering Soul Master boss arena transition")]
        EnterSoulMaster,
        [Description("进入大黄蜂2（切换场景）"), ToolTip("Splits when entering Hornet 2 boss arena transition")]
        EnterHornet2,
        [Description("进入蜂巢骑士（切换场景）"), ToolTip("Splits when entering Hive Knight boss arena transition")]
        EnterHiveKnight,
        [Description("进入剧团团长格林（切换场景）"), ToolTip("Splits when entering Grimm tent with requirements to trigger Troupe Master Grimm boss")]
        EnterTMG,

        [Description("反击蝇之王击杀（切换场景）"), ToolTip("Splits on transition after Vengefly King in Greenpath killed")]
        VengeflyKingTrans,
        [Description("大型苔藓冲锋者击杀（切换场景）"), ToolTip("Splits on transition after Massive Moss Charger is killed")]
        ...
        OnObtainKingsIdol,
        [Description("神秘蛋8（获得）"), ToolTip("Splits when obtaining 8 Arcane Eggs")]
        ArcaneEgg8,
        ...
        OnObtainGrub,
        [Description("苍白矿石（获得）"), ToolTip("Splits when obtaining a Pale Ore")]
        OnObtainPaleOre,
